...
{
  $document->setName($_POST['pageName']);
  $document->setPageFormat($_POST['pageFormat']);
  $document->setPageOrientation($_POST['pageOrientation']);
  $document->setPageMargin($_POST['pageMargin']);
  $document->setHeader($_POST['pageHeader']);
  $document->setBody($_POST['pageBody']);
  $document->setFooter($_POST['pageFooter']);

  $message = $pdfDocument->editDocument($document, $_GET['id']);
        ...
        <div class="col-lg-12">
          <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title">Mise à jour du document</h3>
              <div class="text-right" style="padding-right: 30px; margin-bottom: 20px">
                  <a href="index.php" class="btn btn-primary"><i class="white-600 wb wb-arrow-left"></i> Revenir à la liste des documents</a>
              </div>
            </div>
            <div class="panel-body">
              <form name="documentForm" action="<?php echo($_SERVER['PHP_SELF']) ?>" id="updateFormDoc" method="post">
                <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>
                        ...
                        <input type="text" value="<?php echo ($document->getName()); ?>" name="pageName" id="pageName" class="form-control form-control-sm" placeholder="Entrer le nom du document">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="pageFormat" id="pageFormat" class="form-control form-control-sm">
                          <option selected="" disabled="">
                            -- Choisir le format --
                          </option>
                          <option value="3" <?php if (intval($document->getPageFormat())===3) echo 'selected'; ?>>
                            A3
                          </option>
                          <option value="4" <?php if (intval($document->getPageFormat())===4) echo 'selected'; ?>>
                            A4
                          </option>
                          <option value="5" <?php if (intval($document->getPageFormat())===5) echo 'selected'; ?>>
                            A5
                          </option>
                          <option value="6" <?php if (intval($document->getPageFormat())===6) echo 'selected'; ?>>
                            A6
                          </option>
                        </select>
                      </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="pageOrientation" id="pageOrientation" class="form-control form-control-sm">
                          <option selected="" disabled="">
                            -- Choisir l'orientation --
                          </option>
                          <option value="1" <?php if (intval($document->getPageOrientation())===1) echo 'selected'; ?>>
                            Portrait
                          </option>
                          <option value="2" <?php if (intval($document->getPageOrientation())===2) echo 'selected'; ?>>
                            Paysage
                          </option>
                        </select>
                      </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="pageMargin" id="pageMargin" class="form-control form-control-sm" placeholder="Margins du document" value="<?php echo $document->getPageMargin(); ?>">
                        <span class="help-bloc">
                        Entrer les margins du document séparés par une virgule. (e.g 10,12,10,15 )
                      </span>
                      </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea id="summernoteHeader" name="pageHeader" data-plugin="summernote">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea id="summernoteBody" name="pageBody" data-plugin="summernote">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea id="summernoteFooter" name="pageFooter" data-plugin="summernote">
                    ...
                    <div class="col-md-12">
                      <div class="form-group text-right">
                        <button type="submit" class="btn btn-primary" id="updateDocument" name="updateDocument">
                          Générer & Sauvergarder le document <i class="white-500 wb wb-file"></i>
                        </button>
                      </div>
                    </div>
                </div>
...
<script src="template/global/vendor/babel-external-helpers/babel-external-helpers.js"></script>
  ...
  <script type="text/javascript">
    $('#updateFormDoc').on('submit',function(e){
      e.preventDefault();
      editDocument($(this), "<?php echo($_SERVER['PHP_SELF']) ?>?id=<?php echo $_GET['id']?>");
    });
  </script>
</body>
</html>