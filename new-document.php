...
if(isset($_POST['pageName']))
{
  ...
  $message = $pdfDocument->saveDocument($document);
          	...
          	<ul class="site-menu" data-plugin="menu">
	            <li class="site-menu-category">
            		<a class="animsition-link" href="index.php">
                    	<i class="red-600 wb wb-dashboard"></i> <span class="site-menu-title">Mes documents</span> 
                  	</a>
	          	</li>
          	</ul>
        </div>
        ...
        <div class="col-lg-12">
          <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title">Nouveau document</h3>
            </div>
            <div class="panel-body">
              <form name="documentForm" action="<?php echo($_SERVER['PHP_SELF']) ?>" id="newFormDoc" method="post">
                <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>
                        ...
                        <input type="text" name="pageName" id="pageName" class="form-control form-control-sm" placeholder="Entrer le nom du document">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="pageMargin" id="pageMargin" class="form-control form-control-sm" placeholder="Margins du document">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea id="summernoteHeader" name="pageHeader" data-plugin="summernote"></textarea> 
                      </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea id="summernoteBody" name="pageBody" data-plugin="summernote"></textarea> 
                      </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea id="summernoteFooter" name="pageFooter" data-plugin="summernote"></textarea> 
                      </div>
                    </div>

                    <div class="col-md-12">
                      <div class="form-group text-right">
                        <button type="submit" class="btn btn-primary" id="saveDocument" name="saveDocument">
...
<script src="template/global/vendor/babel-external-helpers/babel-external-helpers.js"></script>
  ...
  <script type="text/javascript">
    $('#newFormDoc').on('submit',function(e){
      e.preventDefault();
      saveDocument($(this), "<?php echo($_SERVER['PHP_SELF']) ?>");
    });
  </script>
</body>
</html>