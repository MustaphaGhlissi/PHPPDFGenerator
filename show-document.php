      ...
      <div class="row" data-plugin="matchHeight" data-by-row="true">
        <div class="col-lg-12">
          <div class="panel">
            ...
            <div class="panel-body">
              <form name="documentForm" id="updateFormDoc" method="post">
                <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>
                        ...
                        <input readonly="" type="text" value="<?php echo ($document->getName()); ?>" name="pageName" id="pageName" class="form-control form-control-sm" placeholder="Entrer le nom du document">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select readonly="" name="pageFormat" id="pageFormat" class="form-control form-control-sm">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select readonly name="pageOrientation" id="pageOrientation" class="form-control form-control-sm">
                          <option selected="" disabled="">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input readonly="" type="text" name="pageMargin" id="pageMargin" class="form-control form-control-sm" placeholder="Margins du document" value="<?php echo $document->getPageMargin(); ?>">
                      ...
                      <div class="form-group">
                        <div class="card">
                          <div class="card-block">
                            <h4 class="card-title">Entete du document</h4>
                            <p class="card-text">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <div class="card">
                          <div class="card-block">
                            <h4 class="card-title">Corps du document</h4>
                            <p class="card-text">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <div class="card">
                          <div class="card-block">
                            <h4 class="card-title">Footer du document</h4>
                            <p class="card-text">
